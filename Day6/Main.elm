...
scene t =
    ...
    in
        ...
        , render vertexShader fragmentShader (cubes.yellow) (uniforms 0 -1 <| (angle -0.8))
        ]
...
uniforms x y t =
    ...
    , rotation =
        -- mul
        (makeRotate (3 * t) (vec3 0 1 0))
        -- (makeRotate (2 * t) (vec3 1 0 0))
...
vertexShader : Shader { attr | position : Vec3, color : Vec3 } Uniforms { vcolor : Vec3 }
vertexShader =
    [glsl|
