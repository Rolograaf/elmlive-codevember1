        ...
        Animation.style
            ...
            |> Animation.queue
                [ Animation.loop
                    ...
                    , Animation.to
                        [ Animation.scale 30
                        , Animation.points (regularPolygon 100)
                        , Animation.fill Color.blue
                        , Animation.rotate (Animation.turn 0.1)
                        ]
                    , Animation.wait 500
                    , Animation.to
                        [ Animation.points (star 5)
                        , Animation.scale 25.0
                        , Animation.fill (Color.hsl (degrees 345) 0.5 0.7)
                        , Animation.rotate (Animation.turn -0.6)
                        , Animation.translate (Animation.px 75) (Animation.px 75)
                        ]
                    , Animation.wait 500
                    , Animation.to
                        [ Animation.points (regularPolygon 3)
...
-- Probably repeats all the points on one side instead of equally divided over the higher resolution one
-- can maybe be solved using algorithm with two loops (= maps in FP)
